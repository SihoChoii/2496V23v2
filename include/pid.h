...
#define STRAIGHT_KP 1 //19 //14//5.75 //7 //9.2 // 10.01 //10 works for 2000
#define STRAIGHT_KI 0.075 //0.5 //0.6 //0.65 //0.126//0.085 works for 2000 // 0.145 for 1000
...
#define STRAIGHT_MAX_INTEGRAL 300
...
#define TURN_INTEGRAL_KI 0.1
#define TURN_MAX_INTEGRAL 0.1
